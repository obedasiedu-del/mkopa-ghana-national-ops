...
function DepotStockSection() {
    const { data, scope, search, openDrawer, openModal } = useApp();
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", marginBottom: 12 } },
            React.createElement("button", { className: "btn btn-primary btn-sm", onClick: () => openModal("bulkDepotStock") }, "+ Upload Stock (All Depots)")),
