...
function useSupabaseData() {
    ...
    const saveDepotStockBulk = React.useCallback(async (byDepotModels) => {
        ...
        if (!codes.length)
            throw new Error("No matched depots to save yet — check the depot names.");
    ...
    return {
        ...
        saveDepotField, addCce, updateCce, deleteCce, saveDeviceModels, saveDepotStockBulk, saveSubmission,
