"use strict";
function AgentLedgerModal({ group }) {
    ...
    return (React.createElement(Modal, { open: true, onClose: closeModal, wide: true, title: group.name, footer: React.createElement("button", { className: "btn", onClick: closeModal }, "Close") },
        ...
        devices.length === 0 ? (React.createElement("div", { style: { padding: "16px 0", color: "var(--text-faint)", fontSize: 12.5 } }, "No devices found for this agent in the current scope.")) : (React.createElement("div", { style: { overflowX: "auto", border: "1px solid var(--border)", borderRadius: 8, maxHeight: 360, overflowY: "auto" } },
