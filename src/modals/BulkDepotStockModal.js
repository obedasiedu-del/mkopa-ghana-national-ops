    ...
    React.createElement("div", { style: { fontSize: 12, margin: "4px 0 14px" } },
      ...
      !parsing && summary && totalRows > 0 && React.createElement(React.Fragment, null,
        React.createElement("div", { style: { color: "var(--success)", fontWeight: 600, marginBottom: 4 } },
          totalRows - summary.unmatchedRows.length, " of ", totalRows, " pasted row", totalRows === 1 ? "" : "s", " matched, across ", depotCodes.length, " depot", depotCodes.length === 1 ? "" : "s", "."),
        ...
        summary.skipped > 0 && React.createElement("div", { style: { color: "var(--text-faint)" } }, summary.skipped, " row(s) skipped (missing depot or model).")),
    ),
